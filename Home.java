...
class Admin extends AdminMenu{
	public void Admin1(){
		Scanner scan = new Scanner(System.in);
		String AdminUserName = "abdur";
		String AdminPassWord = "Abu@01";
...
class AdminMenu{
	public void AdminClsMenu(){
		...
		Scanner scan = new Scanner(System.in);
		System.out.println("1.Add Books | 2.View | 3.Update | 4.Delete |5.Sign Out");
...
class Book {
	...
	public static void Update(){
		...
		if(BookId[UpdateValue-1]!=0){
			...
			System.out.println("1.Book Name | 2.Book Price | 3.Book Count");
